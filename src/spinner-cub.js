 ...
 */
 ...
 ;(function () {
    ...
    mutator.equals = function () {
        this.loaders = document.querySelectorAll('[data-loader="spinner-cub"]');
    ...
    mutator.addLoaders = function () {
        let loaders = document.querySelectorAll('[data-loader="spinner-cub"]');
    ...
    mutator.start = function () {
        ...
        if (this.loaders.length > 0) {
            this.loaders.forEach((item, index) => spinnerLoading(item, index, 'sl-spinner1', 1, 12, 'spinnerCub'));
        }
