...
;(function () {
     ...
     * @param index
     */
    const spinnerDefault = (item, index) => {
    ...
    mutator.equals = function () {
        this.loaders = document.querySelectorAll('[data-loader="spinner-default"]');
    ...
    mutator.addLoaders = function () {
        let loaders = document.querySelectorAll('[data-loader="spinner-default"]');
    ...
    mutator.start = function () {
        ...
        if (this.loaders.length > 0) {
            this.loaders.forEach((item, index) => spinnerDefault(item, index));
        }
