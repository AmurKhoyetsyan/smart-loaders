...
;(function () {
    ...
    mutator.equals = function () {
        this.loaders = document.querySelectorAll('[data-loader="box-up"]');
    ...
    mutator.addLoaders = function () {
        let loaders = document.querySelectorAll('[data-loader="box-up"]');
    ...
    mutator.start = function () {
        ...
        if (this.loaders.length > 0) {
            this.loaders.forEach((item, index) => boxUp(item, index));
        }
