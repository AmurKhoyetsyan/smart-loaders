...
;(function () {
    ...
    mutator.equals = function () {
        this.loaders = document.querySelectorAll('[data-loader="bubble-top"]');
    ...
    mutator.addLoaders = function () {
        let loaders = document.querySelectorAll('[data-loader="bubble-top"]');
    ...
    mutator.start = function () {
        ...
        if (this.loaders.length > 0) {
            this.loaders.forEach((item, index) => bubbleLoading(item, index, 'sl-bubble2', 'sl-bubble', 1, 3, 'bubbleTop'));
        }
